...
switch_case = dict([
    (5, u'Result: Johny Depp'),
    (4, u'Result: Scarlett Johansson'),
    (3, u'Result: Bill Gates'),
    (2, u'Result: Billie Eilish'),
    (1, u'Result: Vladymyr Zelenskiy'),
    (0, u'Result: Angeka Merkel')
])
...
class View:
    ...
    def click_button(self):
        ...
        self.show_results(dict([
            (' ', 'Match percentage'),
            (u'Johny Depp: ', '{:.2f}'.format(self.Yh[5][self.clicks]) + "%"),
            (u'Scarlett Johansson: ', '{:.2f}'.format(self.Yh[4][self.clicks]) + "%"),
            (u'Bill Gates: ', '{:.2f}'.format(self.Yh[3][self.clicks]) + "%"),
            (u'Billie Eilish: ', '{:.2f}'.format(self.Yh[2][self.clicks]) + "%"),
            (u'Vladymyr Zelenskiy: ', '{:.2f}'.format(self.Yh[1][self.clicks]) + "%"),
            (u'Angeka Merkel: ', '{:.2f}'.format(self.Yh[0][self.clicks]) + "%")
        ]))
